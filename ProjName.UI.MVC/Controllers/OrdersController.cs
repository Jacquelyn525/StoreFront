...
namespace ProjName.UI.MVC.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,Quantity,OrderDate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,Quantity,OrderDate")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
